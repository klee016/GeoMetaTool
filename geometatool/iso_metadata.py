...
#        br.text = AssociatedResource[1] 
    ...
    def contentInfo(self, featureCatalogueName, featureCatalogueScopes, versionNumber, versionDate, featureCatalogueLanguageCode, OrganisationName, IndividualName, RoleCode, featureTypeList):
        ...
        ET.SubElement(e, '{'+ lan +'}LanguageCode', codeList=codelist_LanguageCode, codeListValue=featureCatalogueLanguageCode)
